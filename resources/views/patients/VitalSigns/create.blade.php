                ...
                <form action="#" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" class="form-control" id="PAS" placeholder="Presión arterial sistólica" value="{{ old('PAS') }}" v-model="PAS" name="PAS">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="PAD">Presión arterial diastólica PAD</label>
                            <input type="number" class="form-control" id="PAD" placeholder="Presión arterial diastólica PAD" value="{{ old('PAD') }}" v-model="PAD" name="PAD">
                        </div>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" class="form-control" id="breathing_frequency" placeholder="Frecuencia Respiratoria" value="{{ old('breathing_frequency') }}" name="breathing_frequency">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="body_temperature">Temperatura Corporal</label>
                            <input type="number" class="form-control" id="body_temperature" placeholder="Temperatura Corporal" value="{{ old('body_temperature') }}" name="body_temperature">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="beats_per_minute">Latidos por Minuto</label>
                            <input type="number" class="form-control" id="beats_per_minute" placeholder="Latidos por Minuto" value="{{ old('beats_per_minute') }}" name="beats_per_minute">
                        </div>
                    </div>
                    <div class="col-md-3">
                        <button type="submit" class="btn btn-success btn-block" name="button">Guardar Datos</button>
                    </div>
                </form>
            </div>
        </div>
