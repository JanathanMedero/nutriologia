            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-1" class="d-flex justify-content-center">
                        <button class="btn btn-link text-white btn-block" type="button" data-toggle="collapse" data-target="#BloodChemistry" aria-expanded="true" aria-controls="BloodChemistry">
                    ...
                    <form action="{{ route('bloodChemistry.update', $patient->slug) }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" class="form-control" id="reason_alb" placeholder="Razón alb./glob." value="{{ $patient->BloodChemistry->resaon_alb }}" name="reason_alb" data-trigger="focus" data-toggle="tooltip" data-container="body"
